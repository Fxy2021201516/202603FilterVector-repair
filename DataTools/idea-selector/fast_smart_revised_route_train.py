...
SUMMARY_OUT_DIR = os.path.join(BASE_DIR, "SelectModels_summary", "fast_smart_revised_route")
...
def process_single_dataset(dataset_name):
    ...
    csv_path = os.path.join(BASE_DIR,"OLD", "EDA_Plots", dataset_name, f"{dataset_name}_aligned_results.csv")
    output_dir = os.path.join(BASE_DIR, dataset_name, "OLD","SelectModels", "fast_smart_revised_route")
    ...
    els_model_path = os.path.join(BASE_DIR, "OLD",dataset_name, "SelectModels", "intelElS", "idea1_selector_model_final.joblib")
    els_clf = None
