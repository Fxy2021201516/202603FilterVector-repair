...
def main():
    directory_path = "/home/fengxiaoyao/FilterVector/FilterVectorCode/experiment_json/202603-big-FastSmartRoute"
    
    old_text = "navix-prefilter"
    new_text = "FastSmartRoute"
